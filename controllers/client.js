...
exports.sms = async (req, res, next) => {
  ...
  try {
    ...
    const response = await plivo.messages.create({
      src: "+91 63818 63055",   
      dst: '+91 9597831420',
      text: 'Hi, sir this is from sns college, Your son\'s attendance percentage is less than 70'
    });
  ...
  // const apikey = "40SEhI2oUp8E9K8NmLJaDxUQBV0S5BuurRaoRl6EOp3flVUhL3nOIe9gFX1e";
  // const message = "hi king";
  // const phonenumber = "9597831420";
  ...
  //   })
  //   .catch((error) => {
  //     console.log('SMS sent successfully',error);
